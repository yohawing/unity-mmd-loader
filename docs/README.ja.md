...
- **MMD らしいトゥーン表現** — URP ベースのトゥーンシェーディングで、エッジやアルファ、テクスチャ周りを MMD らしい見た目に近づけます。
...
| Humanoid | インポート時に Animator とプロキシリグを自動セットアップ。Timeline 上の統合トラックで Humanoid アバターと MMD モデルを同時駆動し、リターゲット再生中の Live 物理にも対応 |
...
| 項目 | 予定 |
| --- | --- |
| ベイク導線の整理 | 明示的な Humanoid AnimationClip bake の UX と出力オプションの拡充 |
