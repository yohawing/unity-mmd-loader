...
[日本語](https://github.com/yohawing/unity-mmd-loader/blob/main/docs/README.ja.md)
...
| Physics | Real-time physics during playback only |
...
For detailed instructions, see the [How to use MMD Loader](https://github.com/yohawing/unity-mmd-loader/blob/main/docs/HOW_TO_USE.md) guide.
