...
namespace Yohawing.MmdUnity.Tests
{
    public sealed class MmdHumanoidRetargeterTests
    {
        ...
        public void RetargeterUsesImportedHierarchyInputFromPmxAsset()
        {
            ...
            Assert.That(typeof(MmdHumanoidRetargeter).Assembly.GetName().Name, Is.EqualTo("Yohawing.MmdUnity.Runtime"),
        ...
        public void RetargetNoAnimatorAvatarOrAssetDatabaseSideEffects()
        {
            ...
            Assert.That(runtimeAssemblyName, Is.EqualTo("Yohawing.MmdUnity.Runtime"),
        ...
        public void RetargeterAssemblyIsRuntimeOnly()
        {
            ...
            Assert.That(assemblyName, Is.EqualTo("Yohawing.MmdUnity.Runtime"),
