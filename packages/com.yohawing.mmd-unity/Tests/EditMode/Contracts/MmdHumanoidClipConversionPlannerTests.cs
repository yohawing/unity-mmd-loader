...
namespace Yohawing.MmdUnity.Tests
{
    public sealed class MmdHumanoidClipConversionPlannerTests
    {
        private const string FixturePmxPath =
            "Packages/com.yohawing.mmd-unity/Tests/Fixtures/Assets/test_1bone_cube.pmx";

        private const string FixtureVmdPath =
            "Packages/com.yohawing.mmd-unity/Tests/Fixtures/Assets/test_1bone_cube_motion.vmd";
