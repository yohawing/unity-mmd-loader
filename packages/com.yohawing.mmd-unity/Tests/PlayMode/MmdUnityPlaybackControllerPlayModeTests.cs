    ...
    public sealed class MmdUnityPlaybackControllerPlayModeTests
    {
        ...
        private static void WriteNativeSceneSmokeArtifactIfRequested(MmdPlaybackSnapshot snapshot, Vector3 appliedPosition)
        {
            ...
            var report = new NativeSceneSmokeReport
            {
                ...
                modelSourceId = "packages/com.yohawing.mmd-unity/Tests/Fixtures/Assets/test_1bone_cube.pmx",
                motionSourceId = "packages/com.yohawing.mmd-unity/Tests/Fixtures/Assets/test_1bone_cube_motion.vmd",
                physicsMode = "off",
                frameRate = 30.0f,
