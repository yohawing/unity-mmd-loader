...
namespace Yohawing.MmdUnity.Editor
{
    public static class MmdEditorPlaybackLoader
    {
        ...
        private const string MenuPath = "Tools/Yohawing MMD/Load PMX+VMD Playback Into Scene";
        private const string SelectedAssetsMenuPath = "Tools/Yohawing MMD/Load Selected PMX+VMD Assets Into Scene";
