...
namespace Yohawing.MmdUnity.Editor
{
    ...
    {
        private const string MenuPath = "Tools/Yohawing MMD/Load PMX Into Scene";
        private const string SelectedAssetMenuPath = "Tools/Yohawing MMD/Load Selected PMX Asset Into Scene";
