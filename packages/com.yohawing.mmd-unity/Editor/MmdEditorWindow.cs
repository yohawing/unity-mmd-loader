...
using Yohawing.MmdUnity.Editor.Timeline;
...
namespace Yohawing.MmdUnity.Editor
{
    ...
    {
        private const string MenuPath = "Tools/Yohawing MMD/Open Yohawing MMD Window";
        ...
        {
            GetWindow<MmdEditorWindow>("Yohawing MMD");
        }

        [MenuItem("Assets/Yohawing MMD/Add VMD Clip to selected Timeline")]
        ...
        [MenuItem("Assets/Yohawing MMD/Add VMD Clip to selected Timeline", true)]
        ...
        private void OnGUI()
        {
            ...
            EditorGUILayout.LabelField("Yohawing MMD", EditorStyles.boldLabel);
