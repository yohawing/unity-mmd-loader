...
namespace Mmd.Tests
{
    ...
    public sealed class NativeMmdParserVmdSourceContractTests
    {
        ...
        public void LoadMotionUsesVmdJsonParserWithoutSummaryAccessor()
        {
            ...
            CollectionAssert.AreEqual(new byte[] { 2, 6, 10, 14 }, motion.boneKeyframes[0].interpolation.translationY);
            CollectionAssert.AreEqual(new byte[] { 3, 7, 11, 15 }, motion.boneKeyframes[0].interpolation.translationZ);
