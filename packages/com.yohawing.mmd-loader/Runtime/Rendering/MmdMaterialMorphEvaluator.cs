    ...
    public static class MmdMaterialMorphEvaluator
    {
        ...
        private static MmdMaterialDescriptor CloneMaterial(MmdMaterialDescriptor source)
        {
            return new MmdMaterialDescriptor
            {
                ...
                stylizedSpecularColor = CopyVector(source.stylizedSpecularColor),
                stylizedSpecularBoundary = source.stylizedSpecularBoundary,
                stylizedSpecularFeather = source.stylizedSpecularFeather,
                rimColor = CopyVector(source.rimColor),
                rimBoundary = source.rimBoundary,
                rimFeather = source.rimFeather,
                rimLightFollow = source.rimLightFollow,
                emissionColor = CopyVector(source.emissionColor),
                emissionIntensity = source.emissionIntensity,
                usesEmissionMap = source.usesEmissionMap,
                usesEmissionMask = source.usesEmissionMask,
