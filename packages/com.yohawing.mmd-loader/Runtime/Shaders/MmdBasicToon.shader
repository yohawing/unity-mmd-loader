Shader "MMD Basic Toon"
{
    // Public name for new materials. The old MMD Basic URP Toon name remains as a compatibility shader.
    Properties
    {
